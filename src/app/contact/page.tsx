          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                {[{ icon: "📞", label: "Phone", value: "+91 65688 99194", href: "tel:+916268899194" }, { icon: "✉", label: "Email", value: "info@thechoicecompany.in", href: "mailto:info@thechoicecompany.in" }, { icon: "💬", label: "WhatsApp", value: "Chat instantly", href: "https://wa.me/918109000100" }, { icon: "📍", label: "Office", value: "Indore, Madhya Pradesh", href: null }].map(({ icon, label, value, href }) => (
