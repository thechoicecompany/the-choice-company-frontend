...
//   quantity?: number;
//   sortOrder: number;
//   fileType: FileType;           // NEW — drives lightbox behaviour
//   thumbnailUrl: string;         // Always a small JPEG — served fast
//   // fullUrl is NOT returned here — fetched on demand
// }

// export interface GalleryItemDetail extends GalleryItem {
//   fullUrl: string;              // presigned / CDN URL — fetched only when user opens lightbox
// }
...
// // Called only when lightbox opens — fetches the real asset URL
